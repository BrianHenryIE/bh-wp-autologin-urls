 ...
 */
class API_Develop_Test extends \WP_UnitTestCase {
	...
	public function test_add_autologin_to_url_user_email_does_not_exist() {
		...
		$actual = $api->add_autologin_to_url( $url, 'brian@example.com' );
	...
	public function test_add_autologin_to_messages() {
		...
		$test_data_path   = $project_root_dir . '/tests/testdata/testdata/';
		$test_result_path = $project_root_dir . '/tests/testdata/expected/';
